angular.module('product',['customFilter']).controller('productCtrl', function($scope){
    $scope.data = {
            products : [
            ...
            {category : 'BaseBall', description:'KBL 공식 지정구', name:'농구공', price:'56000', id:6},
            {category : 'BaseBall', description:'2015 서울 StreetBall', name:'대회참가권', price:'20000', id:7},
